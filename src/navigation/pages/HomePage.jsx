  ...
  return (
    <div style={{ background: "#232749" }}>
      ...
      >
        ...
        >
          {["Programming", "Art", "Narrative Design", "Game Jams"].map(
            (tag) => (
              <span
                key={tag}
                style={{
      ...
      <div className="p-4">
            ...
            <Row className="align-items-center g-4">
              <Col md={6}>
                ...
                >
                  <div
                    style={{
                      background: "rgba(122,111,255,0.1)",
        ...
        <Card
          style={{
            backgroundColor: "#2e3060",
            border: "1px solid rgba(122,111,255,0.3)",
            borderRadius: "12px",
          }}
        >
          <Card.Body className="p-4">
            <Row className="align-items-center g-4">
              <Col md={6}>
                ...
                <p style={{ color: "#b8b8d0" }}>
                  Scan the QR code or click below to join our Discord.
                </p>
                <Button
