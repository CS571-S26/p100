...
export default function LearnMorePage() {
  ...
  if (loading) {
    return (
      <div style={{ background: "#232749", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
    ...
    <div style={{ background: "#232749", minHeight: "100vh", padding: "60px 20px" }}>
      <Container>
        ...
        <Button
          ...
          style={{ background: "transparent", border: "1px solid rgba(157,147,255,0.4)", color: "#9d93ff", borderRadius: "8px", marginBottom: "32px" }}
        >
          ← Back to Projects
        </Button>
        ...
        <Row className="g-4">
          ...
          <Col md={8}>
            ...
            {teamMembers.length > 0 && (
              <Card className="mb-4" style={{ backgroundColor: "#2e3060", border: "1px solid #232749", borderRadius: "12px" }}>
          ...
          <Col md={4}>
            <Card style={{ backgroundColor: "#2e3060", border: "1px solid #232749", borderRadius: "12px" }}>
              <Card.Body className="p-4">
                <p style={{ fontSize: "11px", letterSpacing: "1.5px", textTransform: "uppercase", color: "#9d93ff", marginBottom: "16px" }}>
                  Details
                </p>
