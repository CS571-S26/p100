      ...
      <Container fluid style={{ backgroundColor: "#232749" }}>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            {isLoggedIn ? (
              <>
                <Nav.Link as={Link} to="/projects/post">Create Project</Nav.Link>
                <Button
                  onClick={handleLogout}
                  size="sm"
                  style={{ background: "transparent", border: "1px solid rgba(157,147,255,0.4)", color: "#9d93ff", borderRadius: "8px", marginLeft: "8px" }}
                >
                  Log out
                </Button>
              </>
